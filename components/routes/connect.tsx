...
export const Connect = ({ object_id }: any) => {
    ...
    return (
      <div className="w-full h-full flex flex-col space-y-4 overflow-y-scroll scrollbar-hide">
        <div className="flex flex-col w-full min-h-fit space-y-1">
          <Label className="text-base font-semibold">Embed the bot</Label>
          <Label className="text-sm font-normal text-gray-400">
            Paste the code snippet below in your HTML code where you want to
            display the Botsonic chatbot.
          </Label>
        </div>
        <Textarea
          value={codeSnippet}
          readOnly
          className="focus-visible:ring-0 focus-visible:ring-offset-0 bg-gray-100 scrollbar-hide h-full"
        />
      </div>
    );
  };