  ...
  return (
    <>
      ...
      <Button
        ...
        style={{ background: !open ? chatbot?.accent_colour : "transparent" }}
        className={cn(
          !open
      ...
      >
        {open ? (
          ...
          <img
            src={chatbot?.chat_bubble_icon}
            alt={chatbot?.chat_bubble_icon}
